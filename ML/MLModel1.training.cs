...
namespace ML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\User\Desktop\Data\amazon_cells_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.10659407F,L2Regularization=0.27244917F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
